...
public class ExpandableColumnViewController: UIViewController, ExpandableColumnLayoutDelegate, UICollectionViewDataSource {
    ...
    public func toggleExpansionForSectionAtIndex(section: Int, animated: Bool, withDuration duration: NSTimeInterval?) {
        self.sectionExpander.toggleExpansionForSectionAtIndex(section, inCollectionView: self.collectionView, animated: animated, withDuration: duration);
    }
}